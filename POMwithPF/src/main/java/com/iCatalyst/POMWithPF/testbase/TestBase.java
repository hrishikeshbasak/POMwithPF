package com.iCatalyst.POMWithPF.testbase;
...
import com.iCatalyst.POMWithPF.customListener.WebEventListener;
import com.iCatalyst.POMWithPF.excelReader.Excel_Reader;
...
//  public EventFiringWebDriver driver;
	...
	static {
		...
		extent = new ExtentReports(".\\src\\main\\java\\com\\iCatalyst\\POMWithPF\\report\\test\\" + formater.format(calendar.getTime()) + ".html", false);
	}

	public void loadData() throws IOException {
		FileInputStream f = new FileInputStream(".\\src\\main\\java\\com\\iCatalyst\\POMWithPF\\config\\config.properties");
		OR.load(f);
	...
	public String[][] getData(String excelName, String sheetName) {
		String path = ".\\src\\main\\java\\com\\iCatalyst\\POMWithPF\\data\\" + excelName;
	...
	public void getScreenShot(String name) {
		...
		try {
			String reportDirectory = new File(".\\src\\main\\java\\com\\iCatalyst\\POMWithPF\\screenshots").getAbsolutePath();
	...
	public void getScreenShot(WebDriver driver, ITestResult result, String folderName) {
		...
		try {
			String reportDirectory = new File(".\\src\\main\\java\\com\\iCatalyst\\POMWithPF\\screenshots").getAbsolutePath();
			File destFile = new File(reportDirectory + "/" + folderName + "/" + methodName + "_" + formater.format(calendar.getTime()) + ".png");
